...
public class AesInsertionPoint implements AuditInsertionPoint {
    ...
    public static final String SCANNER_MARKER_HEADER = "X-AES-Scanner-Handled";
    private static final String SCANNER_MARKER_VALUE = "1";
    ...
    public HttpRequest buildHttpRequestWithPayload(ByteArray payload) {
        ...
        try {
            ...
            return baseRequest.withBody(encrypted)
                    .withAddedHeader(SCANNER_MARKER_HEADER, SCANNER_MARKER_VALUE);
        } catch (Exception e) {

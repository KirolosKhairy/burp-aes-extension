...
| Набор | Результат |
|---|---|
| CryptoTest (40 тестов) | 40/40 PASSED |
| ScannerRepairTest (15 тестов) | 15/15 PASSED |
| AutoEncryptTest | PASSED |

### ✅ Функциональные тесты

| Тест | Результат |
|---|---|
| Plaintext → авто-шифрование | ✅ |
| Invalid JSON → шифруется как байты | ✅ |
| Уже зашифрованный → не шифруется повторно | ✅ |
| Repeater plaintext → авто-шифрование | ✅ |
| Manual Encrypt/Decrypt | ✅ |
| /api/login (успех/ошибка) | ✅ |
| /api/profile (отражённый user_id) | ✅ |
| Фильтрация по хосту | ✅ |
...
### v1.2.0
- 🔄 Автоматическое шифрование ВСЕХ запросов к целевому хосту
- 🔐 Панель Manual Encrypt/Decrypt
- 📝 Корректное отображение plaintext в decrypted_message
- ✓ Статус "Auto-encrypted before sending to server"

### v1.1.0
- 🔧 Исправлена работа Active Scanner
- 🔧 Совместимость build.gradle с Gradle 4.x–9.x
...
📧 kiroloskhairy2019@gmail.com
🔗 [GitHub](https://github.com/KirolosKhairy)
